...
#include "iree/compiler/Dialect/Modules/VMVX/Conversion/VMVXToVM/ConvertVMVXToVMPass.h"
...
inline void registerVMVXPasses() {
  createVMVXTransformPassPipeline();
  createConvertVMVXToVMPass(IREE::VM::TargetOptions{});
}
