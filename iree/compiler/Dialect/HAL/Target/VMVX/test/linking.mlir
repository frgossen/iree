...
module {
  hal.executable @dispatch_0 attributes {sym_visibility = "private"} {
    ...
    hal.executable.target @vmvx, filter="vmvx" {
      ...
      module {
        vm.module @module {
          vm.func @dispatch_0(%arg0: !vm.ref<!vmvx.interface>, %arg1: !vm.ref<!vmvx.buffer>, %arg2: i32, %arg3: i32, %arg4: i32) {
            vm.return
          }
  ...
  hal.executable @dispatch_1 attributes {sym_visibility = "private"} {
    ...
    hal.executable.target @vmvx, filter="vmvx" {
      ...
      module {
        vm.module @module {
          vm.func @dispatch_1(%arg0: !vm.ref<!vmvx.interface>, %arg1: !vm.ref<!vmvx.buffer>, %arg2: i32, %arg3: i32, %arg4: i32) {
            vm.return
          }
  ...
  hal.executable @dispatch_2 attributes {sym_visibility = "private"} {
    ...
    hal.executable.target @vmvx, filter="vmvx" {
      ...
      module {
        vm.module @module {
          vm.func @dispatch_2(%arg0: !vm.ref<!vmvx.interface>, %arg1: !vm.ref<!vmvx.buffer>, %arg2: i32, %arg3: i32, %arg4: i32) {
            vm.return
          }
...
// CHECK-NEXT:          vm.func @dispatch_0(%arg0: !vm.ref<!vmvx.interface>, %arg1: !vm.ref<!vmvx.buffer>, %arg2: i32, %arg3: i32, %arg4: i32) {
// CHECK-NEXT:            vm.return
// CHECK-NEXT:          }
// CHECK-NEXT:          vm.export @dispatch_0
// CHECK-NEXT:          vm.func @dispatch_1(%arg0: !vm.ref<!vmvx.interface>, %arg1: !vm.ref<!vmvx.buffer>, %arg2: i32, %arg3: i32, %arg4: i32) {
// CHECK-NEXT:            vm.return
// CHECK-NEXT:          }
// CHECK-NEXT:          vm.export @dispatch_1
// CHECK-NEXT:          vm.func @dispatch_2(%arg0: !vm.ref<!vmvx.interface>, %arg1: !vm.ref<!vmvx.buffer>, %arg2: i32, %arg3: i32, %arg4: i32) {
// CHECK-NEXT:            vm.return
// CHECK-NEXT:          }
...
//
// CHECK:       func @main() {
// CHECK:         hal.command_buffer.dispatch.symbol<%cmd : !hal.command_buffer> target(@vmvx_linked_1::@vmvx::@dispatch_0) workgroups([%c1, %c1, %c1])
// CHECK-NEXT:    hal.command_buffer.dispatch.symbol<%cmd : !hal.command_buffer> target(@vmvx_linked_1::@vmvx::@dispatch_1) workgroups([%c1, %c1, %c1])
// CHECK-NEXT:    hal.command_buffer.dispatch.symbol<%cmd : !hal.command_buffer> target(@vmvx_linked_1::@vmvx::@dispatch_2) workgroups([%c1, %c1, %c1])
// CHECK-NEXT:    return
// CHECK-NEXT:  }
...
module {
  ...
  hal.executable @dispatch_1 attributes {sym_visibility = "private"} {
    ...
    hal.executable.target @vmvx, filter="vmvx" {
      ...
      module {
        vm.module @module {
          vm.func @dispatch_1(%arg0: !vm.ref<!vmvx.interface>, %arg1: i32, %arg2: i32) {
            vm.return
          }
          vm.export @dispatch_1
        }
...
// CHECK:       hal.executable @vmvx_linked_1 attributes {sym_visibility = "private"} {
// CHECK-NEXT:    hal.interface @io_0 {
// CHECK-NEXT:      hal.interface.binding @arg0, set=0, binding=0, type="StorageBuffer", access="Read"
// CHECK-NEXT:      hal.interface.binding @arg1, set=0, binding=1, type="StorageBuffer", access="Read"
// CHECK-NEXT:      hal.interface.binding @ret0, set=0, binding=2, type="StorageBuffer", access="Write|Discard"
...
// CHECK-NEXT:          }
// CHECK-NEXT:          vm.export @dispatch_0
// CHECK-NEXT:          vm.func @dispatch_1(%arg0: !vm.ref<!vmvx.interface>, %arg1: i32, %arg2: i32) {
// CHECK-NEXT:            vm.return
// CHECK-NEXT:          }
// CHECK-NEXT:          vm.export @dispatch_1
// CHECK-NEXT:        }
...
// CHECK-NEXT:      hal.command_buffer.dispatch.symbol<%arg0 : !hal.command_buffer> target(@vmvx_linked_1::@vmvx::@dispatch_0) workgroups([%c1, %c1, %c1])
// CHECK-NEXT:      hal.command_buffer.dispatch.symbol<%arg0 : !hal.command_buffer> target(@vmvx_linked_1::@vmvx::@dispatch_1) workgroups([%c1, %c1, %c1])
